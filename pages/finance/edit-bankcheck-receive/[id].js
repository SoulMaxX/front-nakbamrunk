...
const EditBankCheck = () => {
  ...
  React.useEffect(() => {
    ...
    axios.get(`${process.env.NEXT_PUBLIC_API}/finance/get_CR?id=` + id, {
      headers: {
  ...
  const handleSubmit = (event) => {
    ...
    axios.put(`${process.env.NEXT_PUBLIC_API}/finance/update_CR?id=` + id, data, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    })
