...
const CreateOfferSell = () => {
  ...
  const handleAdd = (event) => {
    setOtherProd([...otherProd, { othernameprod: "", otherqty: "", otherprice: "", total: 0 }]);
  };
  ...
  const handleChange = (event, index) => {
    ...
    setOtherProd(list);
    list[index]["total"] = list[index].otherqty * list[index].otherprice
    setOtherProd(list);
        ...
        >
          ...
          <Grid container alignItems="center" spacing={2}>
                  ...
                  <TableBody>
                    {cart.map((row) => (
                      ...
                      >
                        ...
                        <TableCell align="center" ><Button onClick={() => increase(row)}>เพิ่ม</Button><Button onClick={() => decrease(row)}>ลด</Button></TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
            ...
            <Grid item xs={12} md={12} lg={12}>
              ...
              >
                ยอดรวม {((otherProd.otherprice != undefined ? Number(otherProd.otherprice) * Number(otherProd.otherqty) : 0) + Number(total) + Number(totalNewProd)).toFixed(2)} บาท
              </Typography>
            ...
            <Grid item xs={12} md={12} lg={5} >
              ...
              >
                ภาษี {(((vat / 100)) * ((otherProd.otherprice != undefined ? Number(otherProd.otherprice) * Number(otherProd.otherqty) : 0) + Number(total) + Number(totalNewProd))).toFixed(2)} บาท
              </Typography>
              {/* <TextField
                open={false}
            ...
            <Grid item xs={12} md={12} lg={12}>
              ...
              >
                ยอดรวมทั้งสิ้น {(((vat / 100) + 1) * ((otherProd.otherprice != undefined ? Number(otherProd.otherprice) * Number(otherProd.otherqty) : 0) + Number(total) + Number(totalNewProd))).toFixed(2)} บาท
              </Typography>
