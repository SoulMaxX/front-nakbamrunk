...
export default function OfferSells() {
  ...
  React.useEffect(() => {
    axios.get(`${process.env.NEXT_PUBLIC_API}/buy/get_allbuyquotation`, {
      headers: {
  ...
  const handleDelete = (e) => {
    axios.post(`${process.env.NEXT_PUBLIC_API}/buy/delete_buyquotation?id=` + id, {}, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    }).then(() => router.reload())
                  ...
                  >
                    ...
                    >
                      <Tooltip title="View" placement="top">
                        <IconButton
                          href={"/buy/offer-buy-details/" + row.id}
                          aria-label="view"
                          size="small"
                          color="info"
                          className="info"
                      ...
                      <Tooltip title="Edit" placement="top">
                        <IconButton
                          href={"/buy/offer-buy-edit/" + row.id}
                          aria-label="edit"
                          size="small"
                          color="primary"
                          className="primary"
