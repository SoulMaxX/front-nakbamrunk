...
export default function BookbanksLists(props) {
  ...
  const handleDelete = (e) => {
    axios.put(`${process.env.NEXT_PUBLIC_API}/finance/delete_CR?id=` + id, {}, {
      headers: {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Button
            href={role.menuFinance?.create == 0 ? "" : "/finance/create-bankcheck-receive"}
                    ...
                    >
                      ...
                      >
                        ...
                        <Tooltip title="Rename" placement="top">
                          <span>
                            <IconButton
                              href={role.menuFinance?.edit == 0 ? "" : "/finance/edit-bankcheck-receive/" + row.id}
                              aria-label="rename"
                              size="small"
                              color="primary"
                              className="primary"
            ...
            <TableFooter>
              <TableRow>
                <TablePagination
                  ...
                  ActionsComponent={BankCheckLists}
