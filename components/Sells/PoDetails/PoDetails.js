                  ...
                  <Table sx={{ minWidth: 650 }} aria-label="simple table" className="dark-table" id="item">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell align="right">รายการ<br/>ยี่ห้อ/รุ่น</TableCell>
                    ...
                    <TableBody>
                      {datas?.prodsellpos?.map((row) => (
                        ...
                        >
                          ...
                          <TableCell align="right">{row.product.name}<br/>{row.product.brand+"/"+row.product.model}</TableCell>
                      ...
                      {datas?.otherproducts?.map((row) => (
                        ...
                        >
                          ...
                          <TableCell align="right"></TableCell>
                          <TableCell align="right"></TableCell>
                          <TableCell align="right">{numberWithCommas(row.amount * row.price)}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
