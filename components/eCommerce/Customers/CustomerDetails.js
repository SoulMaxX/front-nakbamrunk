        ...
        >
          ...
          <Grid item xs={12} md={12} lg={7} xl={7}>
            <Box>
              ...
              <Typography fontSize="15px" fontWeight="500" mb="15px">
                ตัดวันที่:  {new Date(datas.datecut).toLocaleDateString("th-TH")}
              </Typography>
              <Typography fontSize="15px" fontWeight="500" mb="15px">
                บวกเพิ่ม %: {datas.interest} 
              </Typography>
              <Typography fontSize="15px" fontWeight="500" mb="15px">
                วันที่เริ่ม:  {new Date(datas.datestart).toLocaleDateString("th-TH")}
              </Typography>
              <Typography fontSize="15px" fontWeight="500" mb="15px">
                วันที่สิ้นสุด:  {new Date(datas.dateend).toLocaleDateString("th-TH")}
              </Typography>
